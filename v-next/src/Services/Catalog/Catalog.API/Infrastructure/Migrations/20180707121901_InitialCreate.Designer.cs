// <auto-generated />
using System;
using Catalog.API.Infrastructure.Contexts;
...
namespace Catalog.API.Migrations
{
    ...
    [Migration("20180707121901_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Catalog.API.Domain.Beverage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Catalog.API.Domain.BeverageStyle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Catalog.API.Domain.BeverageType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Catalog.API.Domain.Manufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Catalog.API.Domain.Beverage", b =>
                {
                    b.HasOne("Catalog.API.Domain.BeverageStyle", "BeverageStyle")
                        .WithMany()
                        .HasForeignKey("BeverageStyleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Catalog.API.Domain.BeverageType", "BeverageType")
                        .WithMany()
                        .HasForeignKey("BeverageTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Catalog.API.Domain.Manufacturer", "Manufacturer")
                        .WithMany("Beverages")
            ...
            modelBuilder.Entity("Catalog.API.Domain.BeverageStyle", b =>
                {
                    ...
                    b.HasOne("Catalog.API.Domain.BeverageStyle", "Parent")
                        .WithMany("BeverageStyles")

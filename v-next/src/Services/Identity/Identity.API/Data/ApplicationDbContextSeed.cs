namespace BeerAppreciation.Services.Identity.API.Data
{
    using System;
    ...
    public class ApplicationDbContextSeed
    {
            ...
            try
            {
                ...
                if (!context.Users.Any())
                {
                    context.Users.AddRange(useCustomizationData
                        ? this.GetUsersFromFile(contentRootPath, logger)
                        : this.GetDefaultUser());
        ...
        private ApplicationUser CreateApplicationUser(string[] column, string[] headers)
        {
            ...
            user.PasswordHash = this._passwordHasher.HashPassword(user, user.PasswordHash);
        ...
        private IEnumerable<ApplicationUser> GetDefaultUser()
        {
            ...
            user.PasswordHash = this._passwordHasher.HashPassword(user, "Pass@word1");
